...
public class HttpRequestUtil {
    ...
    public static String sendPostMsg(String url, JSONObject json, String token) {
        String result = "";// 返回的结果
        BufferedReader in = null;// 读取响应输入流
        PrintWriter out = null;
        String params = "";// 编码之后的参数
    ...
    public static String sendGetMsg(String url, String token) {
        String result = "";
        BufferedReader in = null;// 读取响应输入流
        try {
